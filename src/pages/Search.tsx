...
const PAGES: { title: string; subtitle: string; to: string; extra?: string }[] = [
  ...
  { title: 'About OHRR', subtitle: 'Mission, hours & address', to: '/about', extra: 'hours address directions contact instagram facebook' },
  { title: 'Contact', subtitle: 'Email and directions', to: '/contact', extra: 'email address directions' },
